...
// Last update Sat Nov 16 14:02:55 2013 martin lequeux-gruninger
//
...
namespace	RType
{
  namespace	View
  {
    ...
    public:
      ...
      sf::Sprite			_selectorSprite;

      int				_option;
      std::vector<sf::Vector2u>	_optionsSelectorPosition;

      Menu(Controller::Controller *c) :
	ADisplay(c) {}
      virtual		~Menu(void) {}
