...
Packet::Packet()
{
	...
	this->_formatClient[1][1] = "1s";	//join
...
{
	if (this->_formatServer[this->_group][this->_instruction].size() > 0 &&
		this->_formatServer[this->_group][this->_instruction][*curIdx % this->_formatServer[this->_group][this->_instruction].size()] == '1')
	{
		*curIdx += 1;
		*curSize += 3;
	}
	else if (this->_formatServer[this->_group][this->_instruction].size() > 0 &&
		this->_formatServer[this->_group][this->_instruction][*curIdx % this->_formatServer[this->_group][this->_instruction].size()] == '2')
	{
		*curIdx += 1;
		*curSize += 4;
	}
	else if (this->_formatServer[this->_group][this->_instruction].size() > 0 &&
		this->_formatServer[this->_group][this->_instruction][*curIdx % this->_formatServer[this->_group][this->_instruction].size()] == 'p')
	{
		*curIdx += 1;
		*curSize += Packet::POSITION_SIZE + 2;
	}
	else if (this->_formatServer[this->_group][this->_instruction].size() > 0 &&
		this->_formatServer[this->_group][this->_instruction][*curIdx % this->_formatServer[this->_group][this->_instruction].size()] == 's')
	{
		*curIdx += 1;
...
void				Packet::show()
{
	...
	printf("Data Size = %d\n", this->_dataSize);
	printf("Format = %s\n", this->_formatServer[this->_group][this->_instruction].c_str());
	printf("***######***\n\n");
}
